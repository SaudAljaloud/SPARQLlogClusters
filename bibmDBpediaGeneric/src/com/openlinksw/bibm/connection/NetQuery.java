...
public class NetQuery {
	...
	Pattern p2 = Pattern.compile("\\bCONSTRUCT\\b");
	Pattern p3 = Pattern.compile("\\bDESCRIBE\\b");
    ...
    private void configureConnection() throws ProtocolException, IOException{
        ...
        Matcher m2 = p2.matcher(this.queryString);
		Matcher m3 = p3.matcher(this.queryString);
